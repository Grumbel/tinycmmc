...
find_path(MPG123_INCLUDE_DIRECTORY mpg123.h
  PATHS ${MPG123_DIR} ${PC_MPG123_INCLUDE_DIRECTORIES}
  PATH_SUFFIXES "include"
  )

find_library(MPG123_LINK_LIBRARY mpg123
...
find_package_handle_standard_args(MPG123
  REQUIRED_VARS MPG123_INCLUDE_DIRECTORY MPG123_LINK_LIBRARY
  )

add_library(MPG123::mpg123 UNKNOWN IMPORTED)
set_target_properties(MPG123::mpg123
  PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${MPG123_INCLUDE_DIRECTORY};${PC_MPG123_INCLUDE_DIRECTORIES}"
