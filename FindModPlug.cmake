...
find_path(MODPLUG_INCLUDE_DIRECTORY libmodplug/modplug.h
  PATHS ${MODPLUG_DIR} ${PC_MODPLUG_INCLUDE_DIRECTORIES}
...
set_target_properties(ModPlug::modplug
  PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${MODPLUG_INCLUDE_DIRECTORY};${PC_MODPLUG_INCLUDE_DIRECTORIES}"
  INTERFACE_LINK_LIBRARIES "${MODPLUG_LIBRARY};${PC_MODPLUG_LINK_LIBRARIES}"
