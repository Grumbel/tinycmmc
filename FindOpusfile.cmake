...
find_path(OPUSFILE_INCLUDE_DIRECTORY opus/opusfile.h
  PATHS ${OPUSFILE_DIR} ${PC_OPUSFILE_INCLUDE_DIRECTORIES}
...
set_target_properties(Opusfile::opusfile
  PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${OPUSFILE_INCLUDE_DIRECTORY};${PC_OPUSFILE_INCLUDE_DIRECTORIES}"
  INTERFACE_LINK_LIBRARIES "${OPUSFILE_LIBRARY};${PC_OPUSFILE_LINK_LIBRARIES}"
